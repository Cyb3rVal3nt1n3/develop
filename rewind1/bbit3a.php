...
DATA;
//echo "$information";
$list1 = str_replace("_",".",$information);
$string2= explode(".",strtoupper($list1));
foreach($string2 as $word){
// echo "{$word}<br/>";
}
//this is to seperate the information starting from the IP address to the postal code.
//the separation is done after removint the underscore and full stops in the text.
...
echo "<br/>";
$information0=array_splice($string2,32,4);
foreach ($information0 as $word7) {
   echo " "."{$word7}";
}
echo "<br/>";
$information1=array_splice($string2,36,4);
foreach ($information1 as $word8) {
   echo " "."{$word8}";
}
echo "<br/>";
$information2=array_splice($string2,40,4);
foreach ($information2 as $word9) {
   echo " "."{$word9}";
}
echo "<br/>";
$information3=array_splice($string2,44,4);
foreach ($information3 as $word10) {
   echo " "."{$word10}";
}
echo "<br/>";
$information4=array_splice($string2,48,4);
foreach ($information4 as $word11) {
   echo " "."{$word11}";
}
echo "<br/>";
$information5=array_splice($string2,52,4);
foreach ($information5 as $word12) {
   echo " "."{$word12}";
}
echo "<br/>";
$information6=array_splice($string2,56,4);
foreach ($information6 as $word13) {
   echo " "."{$word13}";
}
echo "<br/>";
$information7=array_splice($string2,60,4);
foreach ($information7 as $word14) {
   echo " "."{$word14}";
}
echo "<br/>";
 ?>
